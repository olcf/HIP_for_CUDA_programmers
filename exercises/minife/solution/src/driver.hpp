...
//TODO LIST;
  //add streams (eleminate stream0)
  //get overlap working
  //overlap memory copies
  //reduce memory copies down to necessary amount
       ...
       Parameters& params, YAML_Doc& ydoc)
{
  ...
  nvtxRangeId_t r1=nvtxRangeStartA("generate matrix structure");
  ...
  nvtxRangeId_t r2=nvtxRangeStartA("assemble FE data");
  ...
  nvtxRangeId_t r3=nvtxRangeStartA("impose boundary conditions");
  ...
  nvtxRangeId_t r4=nvtxRangeStartA("make local matrix");
